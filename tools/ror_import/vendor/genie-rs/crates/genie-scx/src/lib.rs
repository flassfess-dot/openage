...
pub use player::{PlayerBaseProperties, PlayerStartResources, ScenarioPlayerData, WorldPlayerData};
pub use triggers::{Trigger, TriggerCondition, TriggerEffect, TriggerSystem};
pub use types::*;
pub use victory::{
    LegacyVictoryInfo, VictoryConditions, VictoryEntry, VictoryInfo, VictoryPointEntry,
    VictoryState,
};
...
impl Scenario {
    ...
    pub fn settings(&self) -> &TribeScen {
        &self.format.tribe_scen
    }

    pub fn player_objects(&self) -> &[Vec<ScenarioObject>] {
