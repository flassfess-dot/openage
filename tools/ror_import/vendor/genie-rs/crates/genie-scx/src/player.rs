...
impl PlayerFiles {
    pub fn build_list(&self) -> Option<&str> {
        self.build_list.as_deref()
    }

    pub fn city_plan(&self) -> Option<&str> {
        self.city_plan.as_deref()
    }

    pub fn ai_rules(&self) -> Option<&str> {
        self.ai_rules.as_deref()
    }
}
...
impl PlayerStartResources {
    ...
    pub fn goods(&self) -> i32 {
        self.goods
    }

    pub fn player_color(&self) -> Option<i32> {
        self.player_color
    }
