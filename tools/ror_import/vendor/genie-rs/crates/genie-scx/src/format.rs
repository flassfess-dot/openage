...
impl TribeScen {
    ...
    pub fn player_base_properties(&self) -> &[PlayerBaseProperties] {
        &self.base.player_base_properties
    }

    pub fn player_start_resources(&self) -> &[PlayerStartResources] {
        &self.player_start_resources
    }

    pub fn player_build_lists(&self) -> &[Option<String>] {
        &self.base.player_build_lists
    }

    pub fn player_city_plans(&self) -> &[Option<String>] {
        &self.base.player_city_plans
    }

    pub fn player_ai_rules(&self) -> &[Option<String>] {
        &self.base.player_ai_rules
    }

    pub fn player_files(&self) -> &[PlayerFiles] {
        &self.base.player_files
    }

    pub fn ai_rules_types(&self) -> &[i8] {
        &self.base.ai_rules_types
    }

    pub fn diplomacy(&self) -> &[Vec<DiplomaticStance>] {
        &self.diplomacy
    }

    pub fn victory(&self) -> &VictoryInfo {
        &self.victory
    }

    pub fn victory_all_flag(&self) -> bool {
        self.victory_all_flag
    }

    pub fn multiplayer_victory_type(&self) -> i32 {
        self.mp_victory_type
    }
    ...
    pub fn victory_time(&self) -> i32 {
        self.victory_time
    }

    pub fn disabled_technologies(&self) -> &[Vec<i32>] {
        &self.disabled_techs
    }

    pub fn num_disabled_technologies(&self) -> &[i32] {
        &self.num_disabled_techs
    }

    pub fn disabled_units(&self) -> &[Vec<i32>] {
        &self.disabled_units
    }

    pub fn num_disabled_units(&self) -> &[i32] {
        &self.num_disabled_units
    }

    pub fn disabled_buildings(&self) -> &[Vec<i32>] {
        &self.disabled_buildings
    }

    pub fn num_disabled_buildings(&self) -> &[i32] {
        &self.num_disabled_buildings
    }

    pub fn all_technologies(&self) -> bool {
        self.all_techs
    }

    pub fn player_start_ages(&self) -> &[StartingAge] {
        &self.player_start_ages
    }

    pub fn legacy_victory_info(&self) -> &[Vec<LegacyVictoryInfo>] {
        &self.legacy_victory_info
    }

    pub fn allied_victory(&self) -> &[i32] {
        &self.allied_victory
    }
}
