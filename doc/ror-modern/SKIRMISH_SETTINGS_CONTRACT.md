...
- E5-005 подключил `skirmish_policy_v1`: AI difficulty, cadence, задержку/разделение атак, минимальный/максимальный отряд и оборонную реакцию. Следующая граница — многосторонняя долговременная acceptance-матрица E5-006; успешный короткий smoke ещё не означает полноценную стратегическую игру.
