...
Статус I7: `INTEGRATED`. `PARITY/HARDENED` требуют пользовательских L3-сценариев окружения/отступления, калибровки допусков и производительности массовых групп.
