...
2. E5-001/002 закрыли направленную дипломатию и единый settings/generated-match contract; следующий пакет E5-003 фиксирует data requirements и типы случайных сухопутных/водных карт, затем AI evidence и полноценный матч.
