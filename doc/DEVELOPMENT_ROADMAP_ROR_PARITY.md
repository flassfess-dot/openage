...
E1/E2 закрыты 2026-09-15 как стабильный `INTEGRATED` baseline: пользовательские visual/HUD blockers исправлены, матрица разрешений и boundary gate пройдены. Текущая активная работа — E3 gameplay-core acceptance на одной контрольной skirmish-цивилизации; кампанийный portfolio остаётся заморожен.
