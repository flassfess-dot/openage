...
Текущая активная работа — E1/E2. Пользовательский кадр 2026-09-14 является воспроизведённым blocker: HUD не соблюдает исходные размеры/позиции и resolution policy, health presentation неверна, нижний правый map/fog edge содержит цветной артефакт.
