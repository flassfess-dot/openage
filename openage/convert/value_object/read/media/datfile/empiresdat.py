...
class EmpiresDat(GenieStructure):
    ...
    def get_data_format_members(
        ...
        data_format.extend([
            ...
            (READ_GEN, "tile_width", StorageType.INT_MEMBER, "int16_t"),
            (READ_GEN, "tile_height", StorageType.INT_MEMBER, "int16_t"),
            (READ_GEN, "tile_half_height", StorageType.INT_MEMBER, "int16_t"),
            (READ_GEN, "tile_half_width", StorageType.INT_MEMBER, "int16_t"),
            (READ_GEN, "elev_height", StorageType.INT_MEMBER, "int16_t"),
